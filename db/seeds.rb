...
#   end
User.create(email:"adam@gmail.com",first_name:"Adam",last_name:"Godson",password:"firstman")
User.create(email:"eve@gmail.com",first_name:"Eve",last_name:"Godson",password:"firstwoman")
User.create(email:"snakeboy@gmail.com",first_name:"Luci",last_name:"Fer",password:"lightbringer")
User.create(email:"cainthegardner@gmail.com",first_name:"Cain",last_name:"Adamson",password:"potatoes")
User.create(email:"ablethegoatboy@gmail.com",first_name:"Able",last_name:"Adamson",password:"sheeps")
User.create(email:"thorselfinvited@gmail.com",first_name:"Thor",last_name:"Odinson",password:"ilovecrows")
User.create(email:"john@gmail.com",first_name:"John",last_name:"User",password:"theuser")
User.create(email:"bill@gmail.com",first_name:"William",last_name:"Cosby",password:"moviestar")
User.create(email:"houdini@gmail.com",first_name:"Harry",last_name:"Houdini",password:"escapist")
User.create(email:"ludo@gmail.com",first_name:"Ludwig",last_name:"vanBeethoven",password:"musical")
